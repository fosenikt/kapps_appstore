...
define('O365_APP_ID', 'api://'.getenv("O365_APP_ID"));
...
define('O365_SCOPES', 'openid profile offline_access User.Read Calendars.Read');
define('O365_AUTHORIZE_ENDPOINT', 'https://login.microsoftonline.com/'.getenv("O365_TENANT_ID").'/oauth2/v2.0/authorize');
define('O365_TOKEN_ENDPOINT', 'https://login.microsoftonline.com/'.getenv("O365_TENANT_ID").'/oauth2/v2.0/token');